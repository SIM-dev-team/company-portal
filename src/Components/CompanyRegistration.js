        ...
        <div className='form-wrapper'>
          ...
          <form id="reg" onSubmit={this.handleSubmit}>
            <div className='fullName'>
              ...
              <input required type='text' name='fullName' onChange={this.handleChange}  />
              {errors.fullName.length > 0 && 
                 <span className='error'>{errors.fullName}</span>}
            </div>
            <div className='description'>
              <label htmlFor="description">Company Description</label>
              <textarea required  name='description' onChange={this.handleChange}  />
            ...
            <div className='date form-group col-6'>
              ...
              <input required type='date' name='date' onChange={this.handleChange}  />
            ...
            <div className='regNo form-group col-6'>
              ...
              <input required type='text' name='regNo' onChange={this.handleChange}  />
            ...
            <div className='address'>
              ...
              <input required type='text' name='address' onChange={this.handleChange}  />
            ...
            <div className='employee form-group col-4'>
              ...
              <input required type='number' name='employee' onChange={this.handleChange}  />
            ...
            <div className='pm form-group col-4'>
              ...
              <input required type='number' name='pm' onChange={this.handleChange}  />
              {errors.pm.length > 0 && 
            ...
            <div className='techlead form-group col-4'>
              ...
              <input required type='number' name='techlead' onChange={this.handleChange}  />
